...
public:
    ...
    void initialize(const string& model_file, const string& mean_file,
...
public:
    FloorPlaneClassifier() : nh_("~"), it_(nh_) {
        ...
        nh_.param("model_file", model_file_,
                  std::string("caffenet.caffemodel"));
        ...
        image_sub_ = it_.subscribe<FloorPlaneClassifier>(
            "image", 1, &FloorPlaneClassifier::image_callback, this, transport);
    }
};
